...
import com.example.flughafen.presentation.api.CountryRestController;
...
public class  CountryRestControllerTest {
    ...
    void ensureGetCountriesIsNotEmpty() throws Exception {
        //given
        var request = get("/api/country").accept(MediaType.APPLICATION_JSON);
        when(countryService.getAllCountries()).thenReturn(List.of(Country.builder().countryName("austria").iso2Code("AT").build()));
